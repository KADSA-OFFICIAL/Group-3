...
const LIST: Array[Dictionary] = [
	...
	},
	{
		...
		# 주먹이 들어간다.
		#
		# 0.2 → **0.3초** (#235). 젤리 이동 속도(320px/s)로 96px이고 부채꼴 사거리가
		# 150px이라, 부채 안쪽에 있던 상대도 **보고 나서** 빠져나갈 수 있다.
		# 0.2초는 단순 반응 시간(0.2~0.25초)과 겹쳐서 "보이지만 못 피하는" 예고였다 —
		# #231 때 지켜볼 값으로 적어 두었고 실제로 그랬다.
		#
		# 너무 잘 피해지면 줄이고(0.25가 다음 후보) 너무 안 피해지면 늘릴 값이 여기다 —
